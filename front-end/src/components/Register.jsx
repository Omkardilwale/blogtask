              ...
              <form className="Auth-form" action="" onSubmit={handlesubmit}>
                <div className="Auth-form-content">
                  ...
                  <div className="text-center">
                    Already registered?{" "}
                    <NavLink className="li" to={"/"} ><button className='btn btn-primary'>SignIn</button></NavLink>
                  </div>
                  <div className="form-group mt-3">
                    <label htmlFor="name">Full Name</label>
                    <input
                      type="text" id='name' name="name" onChange={handlechange} required
                  ...
                  <div className="form-group mt-3">
                    ...
                    <input
                     type="email" id='password' name="email" onChange={handlechange}
                      className="form-control mt-1"
                  ...
                  <div className="form-group mt-3">
                    ...
                    <input
                      id='password'type={'password'} name="password" onChange={handlechange}
                      className="form-control mt-1"
